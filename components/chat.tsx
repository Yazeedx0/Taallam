...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col w-full h-[100dvh] bg-[#FFFDE7]">
      <Header />
      ...
      <AnimatePresence>
        {sendingStatus === "sending" && (
          <motion.div
            className="bg-[#FFCC00] text-[#664D00] text-center py-1 text-sm font-bold"
      ...
      <form className="flex w-full bg-[#FFF8E1] py-4 md:py-5 px-3 border-t border-[#FFCC00]/20 sticky bottom-0 shadow-sm">
        <MultimodalInput
          chatId={chatId}
          input={input}
          setInput={setInput}
